...
model_market_market_market = {
	...
	model_market_goods_GOODS_SALT					: (1,			40),
	model_market_goods_GOODS_WHEAT					: (1,			60),
	model_market_goods_GOODS_POTATO					: (1,			50),
	model_market_goods_GOODS_COTTON					: (1,			50),
	model_market_goods_GOODS_RICE					: (1,			40),
	model_market_goods_GOODS_FUR					: (3,			100),
	model_market_goods_GOODS_WOOD					: (1,			60),
	model_market_goods_GOODS_STONE					: (1,			55),
	model_market_goods_GOODS_SAND					: (1,			50),
	model_market_goods_GOODS_OIL					: (2,			30),
	model_market_goods_GOODS_COAL					: (1,			45),
	model_market_goods_GOODS_IRON					: (1,			30),
	model_market_goods_GOODS_COPPER					: (1,			30),
	model_market_goods_GOODS_PRECIOUS_METAL			: (4,		    20),
	model_market_goods_GOODS_RARE_METAL				: (4,			20),
	model_market_goods_GOODS_BREAD					: (1,			45),
	model_market_goods_GOODS_ALCOHOL				: (1,			20),
	model_market_goods_GOODS_SUSHI					: (1,			10),
	model_market_goods_GOODS_TEXTILE				: (1,			40),
	model_market_goods_GOODS_CLOTHES				: (1,			25),
	model_market_goods_GOODS_FURNITURE				: (2,			35),
	model_market_goods_GOODS_STEEL					: (2,			30),
	model_market_goods_GOODS_TOOLS					: (15,			100),
	model_market_goods_GOODS_CEMENT					: (1,			35),
	model_market_goods_GOODS_FUEL					: (2,			20),
	model_market_goods_GOODS_PLASTIC				: (20,			20),
	model_market_goods_GOODS_GLASS					: (1,			30),
	model_market_goods_GOODS_ELECTRONICS_COMPONENT	: (60,			20),
	model_market_goods_GOODS_RADIO					: (4,			20),
	model_market_goods_GOODS_COMPUTER				: (60,			10),
	model_market_goods_GOODS_GUNS					: (40,			20),
	model_market_goods_GOODS_ENGINE					: (60,		    20),
	model_market_goods_GOODS_CAR					: (100,		    20),
	model_market_goods_GOODS_PLANES					: (150,		    10),
	model_market_goods_GOODS_JEWELRY				: (20,		    20),
	model_market_goods_GOODS_PHONE					: (100,		    10),
}

...
bouton_settings = (((Window.half_resolution[0] - 150), (Window.half_resolution[1] + 50)), (BOUTON_LARGEUR, BOUTON_HAUTEUR))
bouton_jouer = (((Window.half_resolution[0] - 150), (Window.half_resolution[1] + 130)), (BOUTON_LARGEUR, BOUTON_HAUTEUR))
